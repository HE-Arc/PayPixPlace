...
class Canvas(models.Model):
    ...
    width = models.IntegerField(default=50, validators=[ MaxValueValidator(300), MinValueValidator(10) ])
    height = models.IntegerField(default=50, validators=[ MaxValueValidator(300), MinValueValidator(10) ])
